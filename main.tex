...
\begin{proof}
  ...
  \textbf{2nd cas} : Calcul de $\zeta(0)$. En multipliant l'équation fonctionnelle par $(1-s)$ et en utilisant $s\Gamma(s)=\Gamma(s+1)$ TODO, on obtient
  \[
    \forall s\neq0,\,s\neq1\quad
...
\begin{proof}
  ...
  En utilisant encore une fois la formule de Stirling complexe TODO, on obtient un $K>0$ tel qu'au voisinage de $+\infty$
