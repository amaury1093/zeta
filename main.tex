...
\begin{proof}
  ...
  Son abscisse de convergence est $1$, et on a d'après la formule \ref{thm:mertens-positif} due à Mertens, $\forall\sigma>1, \forall\gamma\in\mathbb{R}$
 ...
 \end{equation}
  ...
  Soit $\rho=\beta+i\gamma$ de $\zeta$ un zéro de $\zeta$. Nous allons majorer les 3 termes ci-dessus.
  ...
  En choisissant $\sigma=1+(2c_1\ln|\gamma|)^{-1}$, il suite
  \[ 1-\beta\geq\frac{c_1}{14\ln|\gamma|} \]

  ce qui prouve le théorème par contraposée.
\end{proof}
